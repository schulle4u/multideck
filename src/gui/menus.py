...
def _create_deck_menu(owner):
    ...
    owner.new_deck_item = owner.deck_menu.Append(wx.ID_ANY, _("New Deck") + " …\tCtrl+Shift+N")
    owner.delete_deck_item = owner.deck_menu.Append(wx.ID_ANY, _("Delete Deck") + "\tShift+Del")
    owner.move_deck_up_item = owner.deck_menu.Append(wx.ID_ANY, _("Move Deck Up"))
    owner.move_deck_down_item = owner.deck_menu.Append(wx.ID_ANY, _("Move Deck Down"))
    ...
    owner.deck_effects_item = owner.deck_menu.Append(wx.ID_ANY, _("Deck Audio Effects") + " …")
...
def _bind_menu_events(owner):
    ...
    owner.Bind(wx.EVT_MENU, owner._on_new_deck, owner.new_deck_item)
    owner.Bind(wx.EVT_MENU, owner._on_delete_deck, owner.delete_deck_item)
    owner.Bind(wx.EVT_MENU, lambda e: owner._on_move_selected_deck(-1), owner.move_deck_up_item)
    owner.Bind(wx.EVT_MENU, lambda e: owner._on_move_selected_deck(1), owner.move_deck_down_item)
    ...
    owner.Bind(wx.EVT_MENU, owner._on_show_deck_effects_dialog, owner.deck_effects_item)
